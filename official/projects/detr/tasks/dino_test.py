...
from official.projects.detr.tasks import dino as detection
...
class DetectionTFDSTest(tf.test.TestCase):
  ...
  def test_train_step(self):
    config = dino_cfg.DinoTask(
        ...
        losses=dino_cfg.Losses(class_offset=1),
        train_data=dino_cfg.DataConfig(
            tfds_name='coco/2017',
            tfds_split='validation',
            is_training=True,
            global_batch_size=2,
  ...
  def test_validation_step(self):
    config = dino_cfg.DinoTask(
        ...
        losses=dino_cfg.Losses(class_offset=1),
        validation_data=dino_cfg.DataConfig(
            tfds_name='coco/2017',
            tfds_split='validation',
            is_training=False,
            global_batch_size=2,
